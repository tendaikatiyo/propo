...
**Prerequisite:** [Community rent reports (ZW)](./2026-07-08-zw-community-rent-reports-plan.md) ships on `propo.fyi` first — SA work does not start until that feature is live or explicitly deprioritized.  
...
## Community rent reports (deferred)

User-contributed rent data is **ZW-first** — see [2026-07-08-zw-community-rent-reports-plan.md](./2026-07-08-zw-community-rent-reports-plan.md). Do not build SA community submissions until the ZW model is validated (admin workflow, display UX, approval rate). When porting to SA: separate `rent_reports` in the SA Supabase project, ZAR currency, POPIA copy.
...
| [2026-07-08-zw-community-rent-reports-plan.md](./2026-07-08-zw-community-rent-reports-plan.md) | **Prerequisite** — community rent reports on ZW first              |
