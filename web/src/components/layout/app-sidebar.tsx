...
export function MobileTopBar() {
  return (
    <header className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-border/80 bg-background/95 px-4 backdrop-blur-md lg:hidden">
...
export function MobileNav() {
  ...
  const items = NAV_ITEMS.filter((item) =>
    ["/explore", "/cities", "/compare", "/rankings"].includes(item.href)
  );

  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-border/80 bg-background/95 backdrop-blur-md lg:hidden">
